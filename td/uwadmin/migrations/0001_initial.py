    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(related_name='open_bible_stories', to='uwadmin.Contact')),
                ('contributors', models.ManyToManyField(related_name='+', to='uwadmin.Contact', blank=True)),
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('language', models.OneToOneField(related_name='open_bible_story', verbose_name=b'Language', to='uwadmin.LangCode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', models.ManyToManyField(related_name='organizations', to='uwadmin.LangCode')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(related_name='recent_communications', to='uwadmin.Contact')),
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
