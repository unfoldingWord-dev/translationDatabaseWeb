...
urlpatterns = patterns(
    ...
    url(r"languages/(?P<pk>\d+)/works-in-progress/$", WIPListView.as_view(), name="wip_list"),
    url(r"languages/(?P<pk>\d+)/works-in-progress/create/$", WIPCreateView.as_view(), name="wip_create"),
    url(r"languages/(?P<pk>\d+)/scriptures/$", ScriptureListView.as_view(), name="scripture_list"),
    url(r"languages/(?P<pk>\d+)/scriptures/create/$", ScriptureCreateView.as_view(), name="scripture_create"),
    url(r"languages/(?P<pk>\d+)/translation-needs/$", TranslationNeedListView.as_view(), name="translation_need_list"),
    url(r"languages/(?P<pk>\d+)/translation-needs/create/$", TranslationNeedCreateView.as_view(), name="translation_need_create"),
    url(r"languages/(?P<pk>\d+)/resources/$", ResourceListView.as_view(), name="resource_list"),
