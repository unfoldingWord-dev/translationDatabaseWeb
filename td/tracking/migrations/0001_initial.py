    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countries', models.ManyToManyField(help_text=b'Hold Ctrl while clicking to select multiple countries', to='td.Country', verbose_name=b'Countries that speak this language', blank=True)),
