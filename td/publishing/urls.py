...
urlpatterns = patterns(
    ...
    url(r"^obs/$", OfficialResourceListView.as_view(), name="obs_list"),
    url(r"^obs/create/$", OfficialResourceCreateView.as_view(), name="obs_create"),
    url(r"^obs/(?P<pk>\d+)/$", OfficialResourceDetailView.as_view(), name="obs_detail"),
    url(r"^obs/(?P<code>[\w-]+)/update/$", OfficialResourceUpdateView.as_view(), name="obs_update"),
